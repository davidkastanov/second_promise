...
Promise.race(randomPromises).then((result)=>console.log(result)).catch((error)=>console.error(error));

},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequiredd86", {})

//# sourceMappingURL=second_promise.31b563d9.js.map
